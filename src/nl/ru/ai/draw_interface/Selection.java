...
public class Selection {
	...
	public Selection( Drawable shape ) {
		...
		double lineWidth = shape.getStrokeWidth();
	...
	public void draw( Graphics2D g ) {
		...
		lineWidth = shape.getStrokeWidth();
	...
	public Point2D getButtonSpace( Dimension canvas, int buttonSize, int buttonGapSize ) {
		...
		buttonCoords.setLocation( Math.max( Math.min( buttonCoords.getX(), canvas.width - buttonGapSize ), buttonGapSize ), 0.0d );
